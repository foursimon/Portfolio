const projetosLocal = [
    {
        ...
        Imagem: "src/assets/images/projetos/demetech.gif",
    ...
    },
    {
        ...
        Imagem:"src/assets/images/projetos/httpclientapi.gif",
    ...
    },
    {
        ...
        Imagem:"src/assets/images/projetos/viagens.gif",
    ...
    },
    {
        ...
        Imagem:"src/assets/images/projetos/hexadecimal.gif",
        Html_url: "https://github.com/foursimon/Gerador-Hexadecimal"
    },
]
// process.env.NODE_TLS_REJECT_UNAUTHORIZED = "0";
const apikey= "830e3d2c-d8ea-45b0-af61-21e640b23f78"
const api = "https://githubapi2.onrender.com"

export async function BuscarRepositorios(){
    try{
        const resposta = await fetch(`${api}/api/Github`, {
            method: "GET",
            headers: {
        ...
        if(!resposta.ok) throw new Error("Algo deu errado: " + JSON.stringify(conteudo, null, 4))
        return conteudo.length !== 0 ? conteudo : projetosLocal
    }catch (erro){
        console.log(erro)
