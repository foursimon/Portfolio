...
import eu from "../images/trajetoria/eu.jpg"
        ...
        <section className="inicio" id="inicio">
            <div className="inicio-container">
                ...
                <div className="links-container">
                    <a className="link" href="https://www.linkedin.com/in/giovanni-valieri-b81453260/">
                    <img src={linkedin} alt="logo do LinkedIn com tamanho pequeno" />Veja meu perfil no LinkedIn</a>
                    <a className="link" href="https://github.com/foursimon">
